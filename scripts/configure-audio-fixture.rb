...
info={'CFBundleDisplayName'=>'Mimi Audio Test','CFBundleExecutable'=>'$(EXECUTABLE_NAME)','CFBundleIdentifier'=>'$(PRODUCT_BUNDLE_IDENTIFIER)','CFBundleName'=>'$(PRODUCT_NAME)','CFBundlePackageType'=>'APPL','CFBundleShortVersionString'=>'1.0','CFBundleVersion'=>'1','LSRequiresIPhoneOS'=>true,'UILaunchScreen'=>{},'UIBackgroundModes'=>['audio'],'UISupportedInterfaceOrientations'=>['UIInterfaceOrientationPortrait']}

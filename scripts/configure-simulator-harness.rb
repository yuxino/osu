...
sources += [File.join(root, 'native/tests/CloudFixture.swift'), File.join(root, 'native/tests/SimulatorHarness.swift'), File.join(root, 'ios/MimiPrototype/MimiWire.swift')]
